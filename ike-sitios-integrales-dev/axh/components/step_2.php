        ...
        <div class="tbl" id="tblAsistencias">
            ...
            <div class="tbl__body">
                ...
                foreach ($conexion->getData($query) as $val) {
                    ...
                    $asistencias .= '<input type="checkbox" class="chkbox2" name="asistencia[]" value="' . $val['id'] . '" data-costo="' . $val['price'] . '">';
    ...
    <div class="info">
        ...
        <div class="unirse">
            ...
            <div class="unirse__box">
                ...
                <a href="https://dco-ao.hsbc.com.mx/advance?cid=AFF_HBMX_N4_IK0_00002" target="_blank">Saber más
